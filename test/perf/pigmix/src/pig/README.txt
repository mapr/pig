...
on mapr-core 4.x
$PIG_HOME/test/perf/pigmix/bin/generate_data_0.14.sh -r 325000 -w 10000 -u 500

on mapr-core 3.x
$PIG_HOME/test/perf/pigmix/bin/generate_data_3.x_0.14.sh -r 325000 -w 10000 -u 500
...
./runpigmix.pl /opt/mapr/pig/pig-0.14 /opt/mapr/pig/pig-0.14/bin/pig /opt/mapr/pig/pig-0.14/pigperf.jar /opt/mapr/hadoop/hadoop-0.20.2 /opt/mapr/hadoop/hadoop-0.20.2/bin/hadoop $PIG_HOME/test/perf/pigmix/src/pig /pigmix /pigmixresults
