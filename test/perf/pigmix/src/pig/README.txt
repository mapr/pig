Note:
export PIG_HOME=/opt/mapr/pig/pig-0.15
export MAPPERS=10
export REDUCERS=7

on mapr-core 4.x
sudo -u mapr bash $PIG_HOME/test/perf/pigmix/bin/generate_data_0.15.sh -r 325000 -w 10000 -u 500

on mapr-core 3.x
sudo -u mapr bash $PIG_HOME/test/perf/pigmix/bin/generate_data_3.x_0.15.sh -r 325000 -w 10000 -u 500
